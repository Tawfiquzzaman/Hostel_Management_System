...
<head>
  ...
  <body style="background: -webkit-radial-gradient(rgb(136, 15, 159), rgb(6, 19, 31));  background: radial-gradient(rgb(136, 15, 159), rgb(6, 19, 31)); background:url('./assets/img/hotel.jpeg');height:100%; min-height:100%;margin:0;padding:0;">  
            ...
            <div style="width:1000px;
              ...
              -13px -13px 20px 0.5;
">
                <h2 style="color:black"><b>Admin Panel - Dashboard Booking</b></h2>
                ...
                <table style="width:100%; margin:auto">
                    <tr>
                        <td>
                            <h3 style="color:red">User Id</h3>
                        </td>
                        
                        <td>
                            <h3 style="color:red">Booking Date and Time</h3>
                        </td>
                        <td>
                            <h3 style="color:red">Room Type</h3>
                        </td>
                        <td>
                            <h3 style="color:red">Room Rent</h3>
                        </td>

                    </tr>
                    <%
                    Connection con=DbUtils.connect();
                    ResultSet rs=con.createStatement().executeQuery("select  * from booking order by 1 desc");
                    while(rs.next()){
                    %>
                    <tr style="color:black">
                    <td><%= rs.getString("userid") %></td>
                    <td><%= rs.getString("bdate") %> <%= rs.getString("btime") %></td>
