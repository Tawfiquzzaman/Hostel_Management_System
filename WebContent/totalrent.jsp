...
<html lang="en">
  ...
  <body style="background: -webkit-radial-gradient(rgb(136, 15, 159), rgb(6, 19, 31));  background: radial-gradient(rgb(136, 15, 159), rgb(6, 19, 31)); background:url('./assets/img/hotel.jpeg');height:100%; min-height:100%;margin:0;padding:0;">  
            ...
            <form action="bookprocess" method="post">
             ...
             <input type="hidden" value="${param.roomno }" name="roomno">
...
">
              ...
              -13px -13px 20px 0.5;
">
                    <h3 align="left" style="color:black"><b>Total Rent</b></h3>
                    
                    <br>
                    <input type="text" name="rent" placeholder="Total Rent will be shown here"><!-- comment -->
          ...
          <table align="center">
              <tr>
                  ...
                  <td>
                       <a  href="bookroom.jsp">  <button  class="btn btn-warning">Return</button>
