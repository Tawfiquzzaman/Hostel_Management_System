...
<html lang="en">
  ...
  <body style="background: -webkit-radial-gradient(rgb(136, 15, 159), rgb(6, 19, 31));  background: radial-gradient(rgb(136, 15, 159), rgb(6, 19, 31)); background:url('./assets/img/hotel.jpeg');height:100%; min-height:100%;margin:0;padding:0;">  
            ...
            <form action="totalrent.jsp" method="post">
		 
             <input type="hidden" value="${param.bdate }" name="bdate">
             <input type="hidden" value="${param.btime }" name="btime">
...
">
              ...
              -13px -13px 20px 0.5;
">
                    <h3 align="left" style="color:black"><b>Search Room By Number</b></h3>
                    
                    <br>
                    <input type="text" name="roomno" placeholder="Room Nmmber"><!-- comment -->
          ...
          <table align="center">
              <tr>
                  ...
                  <td>
                       <a  href="bookroom.jsp">  <button  class="btn btn-danger">Return</button>
                  ...
                  <td>
                      <button   type="submit" class="btn">Search Room</button>
